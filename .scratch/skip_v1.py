...
for residual in (False, True):
    ...
    selected = [0, 9, 19, 29, 39, 49]
    print(f"--- residual={residual} ---")
    print("grad norm reaching layer l:", np.round([norms[i] for i in selected], 5))
    print("ratio vs layer0:", np.round([norms[i] / norms[0] for i in selected], 6))
