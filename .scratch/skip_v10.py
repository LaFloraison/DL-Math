...
def train(X, y, depth, width, residual, steps=3000, lr=0.003, clip=None, seed=0):
    rng = np.random.default_rng(seed)
...
print("=== depth=15, lr=0.003, 3000 steps ===")
for residual, clip in ((False, None), (True, 5.0), (True, 10.0), (True, 20.0), (True, 50.0)):
    loss, dW0 = train(X, y, 15, 16, residual, lr=0.003, clip=clip)
    print(f"residual={residual} clip={clip}: loss={loss:.4f} | bottom ||dW0||={dW0:.2e}")
